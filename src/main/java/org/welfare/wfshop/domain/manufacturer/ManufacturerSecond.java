package org.welfare.wfshop.domain.manufacturer;
...
@Entity
@Table(name = "tb_manufacturer_second",
        indexes = {
                @Index(name = "idx_manufacturer_second_no", columnList = "manufacturer_second_no"),
...
public class ManufacturerSecond {
    ...
    @Column(name = "manufacturer_second_no", nullable = false, length = 30, columnDefinition = "VARCHAR(30) COMMENT '제조사 세부 번호'")
    private String manufacturerSecondNo;

    @Column(name = "manufacturer_second_name", nullable = false, length = 100, columnDefinition = "VARCHAR(100) COMMENT '제조사 세부 이름'")
    private String manufacturerSecondName;
